...
const changes: EngineChange[] = [
  ...
  },
  {
    ...
    modifiedFiles: ["src/core/gbt_player.s", "src/core/gbt_player_bank1.s"],
  },
  {
    version: "2.0.0-e3",
    description: "Fixed camera offset",
    modifiedFiles: ["src/core/Camera_a.s", "src/states/Shmup.c"],
  },
  {
    version: "2.0.0-e4",
  ...
  },
  {
    version: "2.0.0-e5",
    description:
      "Fix bug in Platformer scenes where player faces the wrong way after changing direction for a few frames",
    modifiedFiles: ["src/states/Platform.c"],
  },
  {
    version: "2.0.0-e6",
    description:
      "Updates to the 'Attach Script to Button' event:\n" +
  ...
  },
  {
    version: "2.0.0-e8",
    description:
      "Add support for preserving some background palettes while palette swapping",
    modifiedFiles: [
      "include/Palette.h",
  ...
  },
  {
    ...
    modifiedFiles: ["include/Input.h"],
  },
  {
    version: "2.0.0-e10",
    description:
      "Fix bug where an attached script overrides default behavior even when not persisted between scenes",
    modifiedFiles: ["src/core/Input.c"],
  },
  {
    version: "2.0.0-e11",
    description: "Improve collision detection between actors and projectiles",
    modifiedFiles: ["src/core/Projectiles_b.c"],
  },
  {
    version: "2.0.0-e12",
    description:
      "Add support for offsetting weapon attack, and flip attack while facing left if using static sprite",
    modifiedFiles: [
  ...
  },
  {
    version: "2.0.0-e13",
    description:
      "Add support for Engine Fields updatable from settings page and using events:\n" +
  ...
  },
  {
    ...
    modifiedFiles: ["src/core/ScriptRunner_b.c"],
  },
  {
    version: "2.0.0-e15",
    description:
      "Update to GBDK 2020 v4 for performance:\n" +
