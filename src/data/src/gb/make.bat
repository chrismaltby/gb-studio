...
..\_gbs\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wl-yt1 -Iinclude -c -o obj/Logo.o src/Logo.c
..\_gbs\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wl-yt1 -Iinclude -c -o obj/Logo_b.o src/Logo_b.c
...
..\_gbs\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wl-yt1 -Iinclude -DUSE_SFR_FOR_REG -Wl-yo32 -Wl-ya4 -o build/rom/game.gb obj/game.o obj/FadeManager.o obj/Stack.o obj/BankManager.o obj/BankData.o obj/UI.o obj/UI_b.o obj/data/bank_17.o obj/data/data_ptrs.o obj/data/strings_16.o obj/Logo.o obj/Logo_b.o obj/SpriteHelpers.o obj/bank3.o obj/Math.o obj/ScriptRunner.o obj/ScriptRunner_b.o obj/Scene.o obj/Scene_b.o  obj/palette_town.music.o obj/gbt_player.o obj/gbt_player_bank1.o
