...
..\..\..\bin\lcc -Wa-l -Wl-m  -autobank -Wb-ext=.rel -Wb-v -Wl-yt19 -Wl-yoA -Wl-ya4 -o autobanks.gb banks.o srcfile_1.o srcfile_2.o srcfile_3.o srcfile_4_not-autobanked.o 
