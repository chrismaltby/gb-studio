...
..\..\..\bin\lcc -mgbz80:ap -Wl-j -Wm-yS  -autobank -Wb-ext=.rel -Wb-v -Wl-yt0x1B -Wl-yoA -Wl-ya4 -o autobanks.pocket banks.o srcfile_1.o srcfile_2.o srcfile_3.o srcfile_4_not-autobanked.o 
