...
..\..\..\bin\lcc -Wm-yC  -Wf-MMD -Wf-Wp-MP  -Wl-yt0x19         -autobank -Wb-v -Wb-ext=.rel  -Iobj -Isrc -o bin\hicolor_pic.gbc obj\test_pattern_tall.o obj\test_pattern_short.o obj\example_image.o obj\main.o obj\gbc_hicolor.o 
