...
..\..\..\bin\lcc -Wa-l -Wl-m  -autobank -Wb-ext=.rel -Wb-v -Wl-yt0x1B -Wl-yoA -Wl-ya4 -o autobanks.gb banks.o srcfile_2.o srcfile_3.o srcfile_4_not-autobanked.o srcfile_1.o 
